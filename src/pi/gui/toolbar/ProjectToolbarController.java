...
public class ProjectToolbarController implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (action.equals("STATS")) {
			if (this.tool.getStControl().getComparatorView() != null)
				this.tool.getStControl().getComparatorView().setVisible(true);
			else if (this.tool.getStControl().getTestsView() != null)
				this.tool.getStControl().getTestsView().setVisible(true);
			else
				JOptionPane.showMessageDialog(tool, "Count statistics first!");
		}
